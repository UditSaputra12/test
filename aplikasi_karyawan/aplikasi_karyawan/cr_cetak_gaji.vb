...
Public Class cr_cetak_gaji
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "aplikasi_karyawan.cr_cetak_gaji.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_cetak_gaji
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_cetak_gaji = New cr_cetak_gaji
        rpt.Site = Me.Site
        Return rpt
    End Function
